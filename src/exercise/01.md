...
- const declaration establishes a new block-scoped local variable
- The value of a constant can't be changed through reassignment using the
  assignment operator, but if a constant is an object, its properties can be
  added, updated, or removed
- this new element can have its properties edited
